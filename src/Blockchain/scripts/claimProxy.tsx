...
import { claimContractL1, claimContractL2, getProvider, uniswapPoolAddress } from "../stark-constants";
...
export async function hstkPrice(){
  try {
    ...
    const contract = new ethers.Contract(uniswapPoolAddress, poolAbi, provider);
