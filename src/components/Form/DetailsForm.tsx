				...
				<VStack
					...
					<Box
						...
						<Box
							...
							<Input
								...
								value={discord}
								onChange={handleDiscordChange}></Input>
						</Box>
					</Box>
					<Box
						w='80%'
					...
					<Box
						...
						<Box
							...
							<Input
								...
								border='0px'
								isDisabled={
									Number(usdtBalance?.data?.formatted) <
										250 &&
					...
					<Box
						...
						>
							...
							Contributor&apos;s round is closed. This form will
							be re-opened bey very soon, for pre-sale bookings .
							{/* <Box
                                py="1"
                                pl="4"
                                cursor="pointer"
			...
			<HStack
				...
				<Box
					...
					<Text
						...
						lineHeight='30px'
						letterSpacing='-0.15px'>
						The HASH token is a key catalyst in the Hashstack
						ecosystem, and will serve 3 primary objectives. <br />
						1. Store of authority(Governance): To enable
						decentralised governance. <br />
						2. Store of value(Utility): For payment of in-dapp
						transaction fees, compensating partner projects, KOLs,
						and community participants who help secure/further the
						Hashstack ecosystem. <br />
						3. Unlock liquidator role: Liquidators on Hashstack take
						the responsibility of repaying the bad debt to the
						Hashstack protocol, in-exchange for acquiring them at a
						discount.
					</Text>
					<Text
						mt='3rem'
						...
						lineHeight='30px'
						letterSpacing='-0.15px'>
						HASH tokens total supply is hard capped to 9,000,000,000
						(9 billion). For TGE, Hashstack has partnered with the
						Industry leading launchpad - Tokensoft that helped
						launch AVAX (Avalanche token), GRT (The Graph token)
