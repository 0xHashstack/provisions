...
const EmissionRateChart = () => {
	...
	return (
		<div className='flex flex-col gap-2 w-full mt-12'>
			{/* Header Box */}
			<div className='flex flex-col items-start h-18 border border-gray-300/30 text-[#E6EDF3] px-6 text-lg font-semibold leading-[30px] rounded-md'>
				<div className='flex w-full gap-2 justify-between my-auto'>
					<div className='flex my-6'>Token Emissions</div>
				</div>
			</div>

			{/* Chart Box */}
			<div className='border border-gray-300/30 rounded-md p-4 sm:p-6 pb-10'>
				<ApexCharts
					options={options}
